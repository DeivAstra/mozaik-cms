...
public class EditTemplateFieldVM extends BaseVM implements I_TemplareConverter {
	
	private static final Constraint urlFieldConstraint = new Constraint() {
		@Override
	...
	*/
	private static final Constraint regexConstraint = new Constraint() {
		@Override
		public void validate(Component comp, Object value)
				throws WrongValueException {
	...
	public void doAfterCompose(
			@ExecutionArgParam("bean") WcmTemplateField bean,
	...
	*/
	...
	public void save(){
		...
		try {
			...
			e.printStackTrace();
			Dialog.error("Error occured while save Template Field", e);
		}
	}
}
