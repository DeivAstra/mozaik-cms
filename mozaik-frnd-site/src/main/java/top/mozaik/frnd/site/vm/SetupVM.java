...
public class SetupVM extends BaseVM {
	...
	private final SettingsBean bean = new SettingsBean();
	...
	public void validateAndTestConnection() {
		...
		Dialog.info("Setup","Connection parameters are correct");
		...
		args.put("callback", new I_Callback() {
			...
			public void call() {
				...
				try {
					...
					writer.newLine();
					writer.close();
					Dialog.info("Setup","Properties file writen successfully");
